...
$mail->SMTPAuth = true;
$mail->Username = 'enquiry@refreshac.co.nz'; // Your Hostinger email address
...
//Recipients
$mail->setFrom('enquiry@refreshac.co.nz', 'Contact Us');
                                                             ...
                                                             <tr>
                                                                <td align="center" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; font-size: 0px; padding: 0; word-break: break-word;">
                                                                   <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:collapse;border-spacing:0px;">
                                                                      <tbody>
                                                                         <tr>
                                                                            <td style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif;width: 160px;" width="160"> <a href="https://refreshac.co.nz/" target="_blank" style="font-family: Open Sans, Helvetica, Tahoma, Arial, sans-serif; padding: 0 10px;"> <img alt="Refresh AC" height="auto" href="https://refreshac.co.nz/" src="https://refreshac.co.nz/assets/img/logo.png" alt="Refresh AC" border="0" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="160"> </a> </td>
                                                                         </tr>
                                                                      </tbody>
                                                                   </table>
                                                                </td>
                                                                ...
                                                                <tr>
                                                                   <td align="center" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                                      <div style="font-family:OpenSans, Helvetica, Tahoma, Arial, sans-serif;font-size:12px;font-weight:400;line-height:20px;text-align:center;color:#4F4F4F;">
                                                                         <br /> &copy; 2023 Refresh AC. All rights reserved.
                                                                         <br />
                                                                      </div>
                                                                   </td>
                                                                </tr>
...
?>
<!-- <script language="javascript">
   window.open("https://refreshac.co.nz/", "_self");
</script> -->